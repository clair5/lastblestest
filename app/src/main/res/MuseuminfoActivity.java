...
public class MuseuminfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_museuminfo);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MuseuminfoActivity.this,MainActivity.class);
    ...
    private final ScanCallback leScanCallback = new ScanCallback() {
        ...
        public void onScanResult(int callbackType, ScanResult result) {
            ...
            if (result.getDevice().toString().equals("CC:56:4B:DD:F2:C2")) {
                ...
                editor.putInt("museum",1);
                editor.commit();
                //위의 함수는 스탬프를 찍기 위해 영구적으로 값 생성

                System.out.println("MU Beacon" + result.getRssi());
                if (result.getRssi() > -100) {
                    name = "MU";
                    System.out.println("MU Beacon" + name);
                }
                if (name.equals("MU")) {
    ...
    public void stopScanning() {
        ...
        AsyncTask.execute(new Runnable() {
            ...
            public void run() {
                if (btScanner != null) {
                    if (ActivityCompat.checkSelfPermission(MuseuminfoActivity.this, Manifest.permission.BLUETOOTH_SCAN) != PackageManager.PERMISSION_GRANTED) {
